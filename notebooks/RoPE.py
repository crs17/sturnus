...
#
# For token position in the context window, a new set of angular values are generated by multiplying the orignal $\theta$ values by the token index. This approach ensures that nearby tokens are rotated by more similar angles than tokens further away in the seqeunce.  
#
